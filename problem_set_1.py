...
def bark():
  ...
  breed = input('Input dog breed')

  formatted_name = name.capitalize()
  formatted_breed = breed.capitalize()

  print(formatted_name + ', the ' + age + ' year old ' + formatted_breed + ', says, "Woof!"')
...
def bark_with_validation():
  ...
  if len(formatted_name) < 2:
    ...
    print("Age error!")
  elif formatted_breed not in ["Schnauzer", "Terrier", "Poodle", "Mastiff"]:
    print("Breed error!")
  else:
    print(formatted_name + ', the ' + age + ' year old ' + formatted_breed + ', says, "Woof!"')
...
def respond_to_anything_but_nonsense():
  ...
  if sentence[-1] == '.':
    ...
    print("Exciting!")
  elif 'nonsense' in sentence == True:
    return
  else:
    print("Please include a punctuation mark at the end of your sentence!")